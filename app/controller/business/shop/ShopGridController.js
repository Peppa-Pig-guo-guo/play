Ext.define('app.controller.business.shop.ShopGridController', {
    extend: 'Ext.app.ViewController',
    alias:'controller.shopShopGridController',
    requires:[
    'app.utils.window',
    'app.view.business.shop.ShopForm'
    ],
    ...
    onAdd:function(){
        var me = this;
        var win = me.lookupReference('ShopForm');
        win = new app.view.business.shop.ShopForm();
        win.title = '添加产品';
        me.getView().add(win);
