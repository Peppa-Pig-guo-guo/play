...
Ext.define('app.utils.ExtUtils', {
  ...
  /**
        ...
        AJAX:function(config){
            var thiz = this;
            config.url = config.url||Myapp.host + config.url;
            config.params = Ext.isEmpty(config.params)?{}:config.params;
            ...
            config.callback = function(options, success, response) {
                ...
                Ext.callback(callback,this,['json',config.scope,success,text,response,options])
            };
